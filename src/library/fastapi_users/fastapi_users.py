...
from library.fastapi_users.authentication import AuthenticationBackend, Authenticator
from library.fastapi_users.jwt import SecretType
from library.fastapi_users.manager import UserManagerDependency
from library.fastapi_users.router import (
    get_auth_router,
    get_register_router,
...
try:
    ...
    from library.fastapi_users.router import get_oauth_router
    from library.fastapi_users.router.oauth import get_oauth_associate_router
...
class FastAPIUsers(Generic[models.UP, models.ID]):
    ...
    def get_verify_router(self, user_schema: Type[schemas.U]) -> APIRouter:
        ...
        :param user_schema: Pydantic schema of a public user.
        """
        return get_verify_router(self.get_user_manager, user_schema, self.authenticator)
