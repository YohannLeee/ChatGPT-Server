...
from library.fastapi_users.authentication.transport.base import Transport
...
class CookieTransport(Transport):
    ...
    async def get_login_response(self, token: str, response: Response) -> Any:
        ...
        return mk_json_res(Message.LOGIN_SUCCESS)
    ...
    async def get_logout_response(self, response: Response) -> Any:
        ...
        return mk_json_res(Message.LOGOUT_SUCCESS)
